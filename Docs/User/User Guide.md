...
This guide is intended for those wanting to use and understand the features of Mul-Ty-Player with a high level overview. If you are looking to understand how MTP functions, please see [the developer guide](../Developer/DeveloperGuide.md). 
...
- [Player Info List](./PlayerInfo.md)
