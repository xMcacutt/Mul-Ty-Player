    ...
    private Dictionary<int, PositionData[]> _staticCogPositions = new()
    {
        ...
        },
        {
            Levels.ShipRex.Id, new PositionData[]
            {
                ...
                new PositionData(2601.4194f, 3035.4546f, -11309.306f),
        ...
        },
        {
            Levels.SnowWorries.Id, new PositionData[]
            {
                ...
                new PositionData(18251.271f, -7704.671f, -13305.25f),
        ...
        },
        {
            Levels.BeyondTheBlackStump.Id, new PositionData[]
            {
                ...
                new PositionData(1023.055f, 6553.167f, 10592.601f),
                ...
                new PositionData(2596.4006f, -304.20312f, -3144.7786f),
                new PositionData(-3236.101f, 1518.222f, 4392.388f),
                new PositionData(-3429.045f, 36.944f, -1969.799f),
                new PositionData(-4727.277f, 973.646f, 252.227f),
    ...
    private Dictionary<int, PositionData[]> _staticBilbyPositions = new()
    {
        ...
        },
        {
            Levels.OutbackSafari.Id, new PositionData[]
            {
                ...
                new PositionData(6918.679f, 3510.002f, -13025.84f, 4.0383616f),
