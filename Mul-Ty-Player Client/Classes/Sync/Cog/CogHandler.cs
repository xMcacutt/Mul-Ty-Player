...
internal class CogHandler : SyncObjectHandler
{
    ...
    {
        LiveObjectAddress = PointerCalculations.GetPointerAddress(0x270424, new[] { 0x0 });
        ProcessHandler.CheckAddress(LiveObjectAddress, (ushort)(17341304 & 0xFFFF), "Cog base address check");
    }
}