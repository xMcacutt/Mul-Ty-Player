...
public class SetupViewModel
{
    ...
    public SetupViewModel()
    {
        var path = Environment.ExpandEnvironmentVariables("%ProgramFiles(x86)%") +
                   "/Steam/Steamapps/Common/Ty the Tasmanian Tiger/";
    ...
    private void InstallWorker_DoWork(object sender, DoWorkEventArgs e)
    {
        ...
        {
            long totalBytes;
            foreach (var file in TyFileNames)
            {
                ...
                if (file == "TY.exe")
                {
                    var versionStringOffset = 0x2024F8;
        ...
        var url = "https://drive.google.com/u/0/uc?id=1OTudAOfutB458mm2qKqRlX1Hi73h8WQw&export=download&confirm";
        ...
        if (!string.IsNullOrEmpty(url))
        {
            ...
            using FileStream fileStream =
                new(destinationPath, FileMode.Create, FileAccess.Write, FileShare.None, 4096, true);
