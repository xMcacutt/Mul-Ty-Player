...
namespace MulTyPlayerClient.GUI.ViewModels
{
    ...
    public class SetupViewModel : BaseViewModel
    {
        ...
        public readonly static string[] TyFileNames = { "Data_PC.rkv", "Music_PC.rkv", "Override_PC.rkv", "Video_PC.rkv", "OpenAL32.dll", "soft_oal.dll", "steam_api.dll", "steam_appid.txt", "TY.exe" };
