...
namespace MulTyPlayerClient.Memory
{
    internal class TyProcess
    {
        ...
        public static bool LaunchingGame
        {
            get; private set;
        }
        ...
        public static bool FindProcess()
        {
            ...
            {
                //Multiple found
                ChatLog.Write($"WARNING: Multiple ({processes.Length}) instances of Mul-Ty-Player are open, can and will cause fuckery.");
        ...
        {
            Log.WriteDebug("Got process, pulling data");
        ...
        {
            Log.WriteDebug($"Output data received: {e.Data}");
        }

        private static void Process_ErrorDataReceived(object sender, DataReceivedEventArgs e)
        {
            Log.WriteDebug($"Error data received: {e.Data}");
        }
    }
}
