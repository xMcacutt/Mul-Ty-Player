...
namespace MulTyPlayerClient.Sync
{
    internal class OpalHandler : SyncObjectHandler
    {
        ...
        public override void SetMemAddrs()
        {
            ...
            NonCrateOpalsAddress = Addresses.GetPointerAddress(gemPtrListAddress, new int[] { 0x0, 0x0 });
            //B3OpalsAddress = PointerCalculations.GetPointerAddress(gemPtrListAddress, new int[] {0x2B0, 0x0});
            CrateOpalsAddress = Addresses.GetPointerAddress(gemPtrListAddress, new int[] { 0x4AC, 0x0 });
        }
